...
void rtlSetup() {
  ...
  if (!cfg->demod) {
    ...
    memcpy(&cfg->devices[53], &kw9015b, sizeof(r_device));
    memcpy(&cfg->devices[54], &interlogix, sizeof(r_device));
    memcpy(&cfg->devices[55], &intertechno, sizeof(r_device));
    memcpy(&cfg->devices[56], &kedsum, sizeof(r_device));
    memcpy(&cfg->devices[57], &kerui, sizeof(r_device));
    memcpy(&cfg->devices[58], &lacrossetx, sizeof(r_device));
    memcpy(&cfg->devices[59], &lacrosse_tx141x, sizeof(r_device));
    memcpy(&cfg->devices[60], &lacrosse_ws7000, sizeof(r_device));
    memcpy(&cfg->devices[61], &lacrossews, sizeof(r_device));
    memcpy(&cfg->devices[62], &lightwave_rf, sizeof(r_device));
    memcpy(&cfg->devices[63], &markisol, sizeof(r_device));
    memcpy(&cfg->devices[64], &maverick_et73, sizeof(r_device));
    memcpy(&cfg->devices[65], &mebus433, sizeof(r_device));
    memcpy(&cfg->devices[66], &missil_ml0757, sizeof(r_device));
    memcpy(&cfg->devices[67], &new_template, sizeof(r_device));
    memcpy(&cfg->devices[68], &nexus, sizeof(r_device));
    memcpy(&cfg->devices[69], &nice_flor_s, sizeof(r_device));
    memcpy(&cfg->devices[70], &opus_xt300, sizeof(r_device));
    memcpy(&cfg->devices[71], &oregon_scientific, sizeof(r_device));
    memcpy(&cfg->devices[72], &oregon_scientific_sl109h, sizeof(r_device));
    memcpy(&cfg->devices[73], &oregon_scientific_v1, sizeof(r_device));
    memcpy(&cfg->devices[74], &philips_aj3650, sizeof(r_device));
    memcpy(&cfg->devices[75], &philips_aj7010, sizeof(r_device));
    memcpy(&cfg->devices[76], &prologue, sizeof(r_device));
    memcpy(&cfg->devices[77], &quhwa, sizeof(r_device));
    memcpy(&cfg->devices[78], &rftech, sizeof(r_device));
    memcpy(&cfg->devices[79], &rubicson, sizeof(r_device));
    memcpy(&cfg->devices[80], &rubicson_48659, sizeof(r_device));
    memcpy(&cfg->devices[81], &s3318p, sizeof(r_device));
    memcpy(&cfg->devices[82], &silvercrest, sizeof(r_device));
    memcpy(&cfg->devices[83], &skylink_motion, sizeof(r_device));
    memcpy(&cfg->devices[84], &smoke_gs558, sizeof(r_device));
    memcpy(&cfg->devices[85], &solight_te44, sizeof(r_device));
    memcpy(&cfg->devices[86], &springfield, sizeof(r_device));
    memcpy(&cfg->devices[87], &tfa_30_3221, sizeof(r_device));
    memcpy(&cfg->devices[88], &tfa_drop_303233, sizeof(r_device));
    memcpy(&cfg->devices[89], &tfa_pool_thermometer, sizeof(r_device));
    memcpy(&cfg->devices[90], &tfa_twin_plus_303049, sizeof(r_device));
    memcpy(&cfg->devices[91], &thermopro_tp11, sizeof(r_device));
    memcpy(&cfg->devices[92], &thermopro_tp12, sizeof(r_device));
    memcpy(&cfg->devices[93], &thermopro_tx2, sizeof(r_device));
    memcpy(&cfg->devices[94], &ts_ft002, sizeof(r_device));
    memcpy(&cfg->devices[95], &visonic_powercode, sizeof(r_device));
    memcpy(&cfg->devices[96], &waveman, sizeof(r_device));
    memcpy(&cfg->devices[97], &wg_pb12v1, sizeof(r_device));
    memcpy(&cfg->devices[98], &ws2032, sizeof(r_device));
    memcpy(&cfg->devices[99], &wssensor, sizeof(r_device));
    memcpy(&cfg->devices[100], &wt1024, sizeof(r_device));
    memcpy(&cfg->devices[101], &X10_RF, sizeof(r_device));
    memcpy(&cfg->devices[102], &x10_sec, sizeof(r_device));

    // end of fragement

#else
    memcpy(&cfg->devices[0], &honeywell, sizeof(r_device));
#endif
